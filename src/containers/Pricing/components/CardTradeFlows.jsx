...
const paperPlane = `${process.env.PUBLIC_URL}/images/pricing_cards/004-paper-plane.svg`;

const CardTradeFlows = () => (
  <Col md={6} xl={3} sm={12}>
    <Card>
      <CardBody className="pricing-card pricing-card--primary">
        <div className="pricing-card__body">
          <img className="pricing-card__img" src={paperPlane} alt="" />
          <h3 className="pricing-card__plan">Trade Flows</h3>
          <hr />
