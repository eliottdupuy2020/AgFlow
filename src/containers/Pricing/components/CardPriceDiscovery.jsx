...
const balloon = `${process.env.PUBLIC_URL}/images/pricing_cards/002-hot-air-balloon.svg`;

const CardPriceDiscovery = () => (
  <Col md={6} xl={3} sm={12}>
    <Card>
      <CardBody className="pricing-card pricing-card--info">
        <div className="pricing-card__body">
          <img className="pricing-card__img" src={balloon} alt="" />
          <h3 className="pricing-card__plan">Price Discovery</h3>
          <hr />
...
export default CardPriceDiscovery;
